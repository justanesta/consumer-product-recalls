...
| USCG Phase 5d detail capture (Path B, **bronze-only**) — ✓ MERGED (#42) | `project_scope/archive/phase-5d-uscg-manufacturers-detail.md` | `feature/uscg-manufacturers-detail-addition` — merged in PR #42; SCD-2 silver half deferred to Phase 6b (ADR 0035) |

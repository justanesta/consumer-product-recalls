...
* [Enforcement Reports API Usage Documentation](https://www.accessdata.fda.gov/scripts/ires/apidocs/)
* [Enforcement Report API Definitions](https://www.fda.gov/safety/enforcement-reports/enforcement-report-api-definitions)
* [OpenFDA](https://open.fda.gov/)

# USCG
* [Defect Notification page](https://uscgboating.org/content/defect-notification.php)
* [Recalls page](https://uscgboating.org/content/recalls.php)

# CPSC
* [CPSC Recalls Application Program Interface (API) Information page](https://www.cpsc.gov/Recalls/CPSC-Recalls-Application-Program-Interface-API-Information)

# NHTSA
* [Recalls landing page](https://www.nhtsa.gov/recalls)
* [NHTSA Datasets and APIs --> Recalls details page](https://www.nhtsa.gov/nhtsa-datasets-and-apis)

# USDA
* [FSIS Recalls & Public Health Alerts landing page](https://www.fsis.usda.gov/recalls)
...
* [Data dot gov Pesticide Product Information System (PPIS)](https://catalog.data.gov/dataset/pesticide-product-information-system-ppis-650ec)

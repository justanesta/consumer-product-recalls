...
**USCG** — Phase 5d. Apply the SCD framework from the outset rather than incurring the 11-tuple → 6-tuple migration cost later. Add a USCG entry to ADR 0031's per-source table and this ADR's cross-source implications subsection when Phase 5d lands.
